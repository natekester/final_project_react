...
import {getClosedGraphScrap, } from './Functions'
...
const options = {
    ...
    title:{
      display:true,
      text:'Closed Scrap Dollars by Cause',
      fontSize:24,
      fontColor: "white",
      fontStyle: 'bold'
    },
...
class ScrapGraphClosed extends Component {
  constructor(props){
    super(props); 
  ...
  async getData(){
    let {prod1, prod2, prod3, prod1Desc,prod2Desc,prod3Desc, labels} = await getClosedGraphScrap();
...
}export default ScrapGraphClosed;
